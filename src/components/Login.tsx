  ...
  return (
    <div className="flex min-h-screen bg-black overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 right-12 z-10">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-2xl bg-green-400 text-black">
            ...
            <h2 className="text-5xl font-black text-white leading-tight mb-4 tracking-tight">
              ...
              <span className="text-green-400">ALTA PERFORMANCE</span>
            </h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gym-dark relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-green-400/5 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        >
          <div className="flex flex-col items-center mb-12">
            <div className="p-4 mb-4 rounded-2xl bg-green-400/10">
